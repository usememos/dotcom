...
description: In Memos v0.12.0, we introduced three storage options for resources - database, S3, and local storage. Learn about each option's advantages and how to choose the right one for your needs.
published_at: 2023/6/24 10:30:00
tags: ["Storage", "Self-Hosting"]
---
