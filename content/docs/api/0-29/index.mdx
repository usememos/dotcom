---
title: API Reference
description: Memos API Reference (0.29.x)
---

## Overview

This reference applies to Memos `0.29.x`. It is generated from the OpenAPI schema in `v0.29.1`.
...
<Cards>
  <Card title="AI Service" href="/docs/api/0-29/aiservice/Transcribe" />
  <Card title="Attachment Service" href="/docs/api/0-29/attachmentservice/CreateAttachment" />
  <Card title="Auth Service" href="/docs/api/0-29/authservice/SignIn" />
  <Card title="Identity Provider Service" href="/docs/api/0-29/identityproviderservice/CreateIdentityProvider" />
  <Card title="Instance Service" href="/docs/api/0-29/instanceservice/GetInstanceProfile" />
  <Card title="Memo Service" href="/docs/api/0-29/memoservice/CreateMemo" />
  <Card title="Shortcut Service" href="/docs/api/0-29/shortcutservice/CreateShortcut" />
  <Card title="User Service" href="/docs/api/0-29/userservice/CreateUser" />
</Cards>
