---
title: API Reference
description: Memos API Reference (0.31.x)
---

## Overview

This reference applies to Memos `0.31.x`. It is generated from the OpenAPI schema in `v0.31.0`.
...
<Cards>
  <Card title="AI Service" href="/docs/api/0-31/aiservice/Transcribe" />
  <Card title="Attachment Service" href="/docs/api/0-31/attachmentservice/CreateAttachment" />
  <Card title="Auth Service" href="/docs/api/0-31/authservice/SignIn" />
  <Card title="Identity Provider Service" href="/docs/api/0-31/identityproviderservice/CreateIdentityProvider" />
  <Card title="Instance Service" href="/docs/api/0-31/instanceservice/GetInstanceProfile" />
  <Card title="Memo Service" href="/docs/api/0-31/memoservice/CreateMemo" />
  <Card title="Space Service" href="/docs/api/0-31/spaceservice/CreateSpace" />
  <Card title="User Service" href="/docs/api/0-31/userservice/CreateUser" />
</Cards>
