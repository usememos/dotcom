...
This reference applies to Memos `0.26.x`. It is generated from the OpenAPI schema in `v0.26.2`.
...
<Cards>
  <Card title="Activity Service" href="/docs/api/0-26/activityservice/GetActivity" />
  <Card title="Attachment Service" href="/docs/api/0-26/attachmentservice/CreateAttachment" />
  <Card title="Auth Service" href="/docs/api/0-26/authservice/SignIn" />
  <Card title="Identity Provider Service" href="/docs/api/0-26/identityproviderservice/CreateIdentityProvider" />
  <Card title="Instance Service" href="/docs/api/0-26/instanceservice/GetInstanceProfile" />
  <Card title="Memo Service" href="/docs/api/0-26/memoservice/CreateMemo" />
  <Card title="Shortcut Service" href="/docs/api/0-26/shortcutservice/CreateShortcut" />
  <Card title="User Service" href="/docs/api/0-26/userservice/CreateUser" />
</Cards>
