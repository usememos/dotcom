...
This reference matches the Memos `0.29.x` release.
...
<Cards>
  <Card title="AI Service" href="/docs/api/0-29-1/aiservice/Transcribe" />
  <Card title="Attachment Service" href="/docs/api/0-29-1/attachmentservice/CreateAttachment" />
  <Card title="Auth Service" href="/docs/api/0-29-1/authservice/SignIn" />
  <Card title="Identity Provider Service" href="/docs/api/0-29-1/identityproviderservice/CreateIdentityProvider" />
  <Card title="Instance Service" href="/docs/api/0-29-1/instanceservice/GetInstanceProfile" />
  <Card title="Memo Service" href="/docs/api/0-29-1/memoservice/CreateMemo" />
  <Card title="Shortcut Service" href="/docs/api/0-29-1/shortcutservice/CreateShortcut" />
  <Card title="User Service" href="/docs/api/0-29-1/userservice/CreateUser" />
</Cards>
