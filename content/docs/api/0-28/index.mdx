---
title: API Reference
description: Memos API Reference (0.28.x)
---

## Overview

This reference applies to Memos `0.28.x`. It is generated from the OpenAPI schema in `v0.28.0`.
...
<Cards>
  <Card title="AI Service" href="/docs/api/0-28/aiservice/Transcribe" />
  <Card title="Attachment Service" href="/docs/api/0-28/attachmentservice/CreateAttachment" />
  <Card title="Auth Service" href="/docs/api/0-28/authservice/SignIn" />
  <Card title="Identity Provider Service" href="/docs/api/0-28/identityproviderservice/CreateIdentityProvider" />
  <Card title="Instance Service" href="/docs/api/0-28/instanceservice/GetInstanceProfile" />
  <Card title="Memo Service" href="/docs/api/0-28/memoservice/CreateMemo" />
  <Card title="Shortcut Service" href="/docs/api/0-28/shortcutservice/CreateShortcut" />
  <Card title="User Service" href="/docs/api/0-28/userservice/CreateUser" />
</Cards>
