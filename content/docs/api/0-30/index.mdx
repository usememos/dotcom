---
title: API Reference
description: Memos API Reference (0.30.x)
---

## Overview

This reference applies to Memos `0.30.x`. It is generated from the OpenAPI schema in `v0.30.0-rc.1`.
...
<Cards>
  <Card title="AI Service" href="/docs/api/0-30/aiservice/Transcribe" />
  <Card title="Attachment Service" href="/docs/api/0-30/attachmentservice/CreateAttachment" />
  <Card title="Auth Service" href="/docs/api/0-30/authservice/SignIn" />
  <Card title="Identity Provider Service" href="/docs/api/0-30/identityproviderservice/CreateIdentityProvider" />
  <Card title="Instance Service" href="/docs/api/0-30/instanceservice/GetInstanceProfile" />
  <Card title="Memo Service" href="/docs/api/0-30/memoservice/CreateMemo" />
  <Card title="Shortcut Service" href="/docs/api/0-30/shortcutservice/CreateShortcut" />
  <Card title="User Service" href="/docs/api/0-30/userservice/CreateUser" />
</Cards>
