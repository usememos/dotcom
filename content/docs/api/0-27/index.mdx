...
This reference applies to Memos `0.27.x`. It is generated from the OpenAPI schema in `v0.27.1`.
...
<Cards>
  <Card title="AI Service" href="/docs/api/0-27/aiservice/Transcribe" />
  <Card title="Attachment Service" href="/docs/api/0-27/attachmentservice/CreateAttachment" />
  <Card title="Auth Service" href="/docs/api/0-27/authservice/SignIn" />
  <Card title="Identity Provider Service" href="/docs/api/0-27/identityproviderservice/CreateIdentityProvider" />
  <Card title="Instance Service" href="/docs/api/0-27/instanceservice/GetInstanceProfile" />
  <Card title="Memo Service" href="/docs/api/0-27/memoservice/CreateMemo" />
  <Card title="Shortcut Service" href="/docs/api/0-27/shortcutservice/CreateShortcut" />
  <Card title="User Service" href="/docs/api/0-27/userservice/CreateUser" />
</Cards>
