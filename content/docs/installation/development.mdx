...
**Ready to Contribute?** Check out the [GitHub repository](https://github.com/usememos/memos) for detailed information about the contribution process, coding standards, and community guidelines.
</Callout>

## Next Steps

- [Read the Contributing Guide](https://github.com/usememos/memos/blob/main/CONTRIBUTING.md)
- [Explore the API Documentation](https://memos.apidocumentation.com)
...
Need help with your development setup? Join our [GitHub Discussions](https://github.com/usememos/memos/discussions) or check [GitHub Issues](https://github.com/usememos/memos/issues) for common solutions.
