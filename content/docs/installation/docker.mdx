...
1. **[Set up a reverse proxy](/docs/deployment/https)** for HTTPS
2. **[Configure authentication](/docs/configuration/authentication)** 
3. **[Set up backups](/docs/configuration/backup)**
4. **[Explore the API](/docs/api)**
