...
| `MEMOS_INSTANCE_URL` | `` | Public instance URL; empty enables private mode |
...
The quick-start command at the top of this page omits `MEMOS_INSTANCE_URL`, so it runs in private mode. The example above enables public mode and anonymous public surfaces by setting the canonical external URL.
