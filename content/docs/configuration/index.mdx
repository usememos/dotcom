...
`MEMOS_INSTANCE_URL` is also an access-mode switch in Memos 0.30 and later. Leave it empty for private mode; set it to the canonical external URL to enable anonymous public surfaces such as Explore and RSS.
