...
- [Monitor your instance](/docs/troubleshooting) for security events
- [Plan incident response](/docs/deployment/monitoring) procedures

---

Need help with security configuration? Consult with security professionals and check our [troubleshooting guide](/docs/troubleshooting) for common security issues.