...
- leave `MEMOS_INSTANCE_URL` empty for a private-only instance
- set it to the canonical public URL when you want anonymous public access or when the app sits behind a proxy
