...
The server uses the **Streamable HTTP** transport. Point any MCP client that supports it at your instance's `/mcp` endpoint and authenticate with a [personal access token](/docs/admin/tokens) as a Bearer credential:
...
Create and revoke personal access tokens from your user settings in the app. See [Tokens](/docs/admin/tokens).
