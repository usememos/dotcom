...
- ✅ Good: "My iPhone", "Backup Script", "Home Laptop App"
- ❌ Bad: "token1", "test", "new"
...
<Cards>
  <Card title="Review Regularly" icon="Eye">
    Check active sessions weekly for unknown devices
  </Card>
  <Card title="Public Computers" icon="Monitor">
    Always log out from public or shared computers
  </Card>
  <Card title="Unknown Sessions" icon="AlertTriangle">
    Revoke immediately if you see a session you don't recognize
  </Card>
  <Card title="Use HTTPS" icon="Lock">
    Always access Memos over HTTPS in production
  </Card>
</Cards>
...
<Cards>
  <Card title="One Per Device" icon="Smartphone">
    Create separate tokens for each app or device
  </Card>
  <Card title="Descriptive Names" icon="Tag">
    Use clear names to identify what each token is for
  </Card>
  <Card title="Set Expiration" icon="Calendar">
  ...
  <Card title="Store Securely" icon="Shield">
    Use password managers, keychains, or secure vaults
  </Card>
  <Card title="Never Share" icon="XCircle">
    Don't commit tokens to git or share publicly
  </Card>
</Cards>
