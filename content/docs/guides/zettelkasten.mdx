...
relatedPages: ["/docs/usage/memos", "/docs/usage/tags", "/docs/usage/views", "/docs/usage/search-archive", "/docs/guides/getting-things-done"]
---
...
A second [View](/docs/usage/views) can surface recent Zettelkasten memos for a connection pass:
