...
2. give the View a clear title and optionally choose a custom icon or emoji with the icon picker
...
Views appear in the sidebar. Select one to apply its filter to your memo list; the selection also syncs to the URL, so you can bookmark it. To keep a search you tried in [Quick Find](/docs/usage/search-archive#quick-find-and-browsing-scope), copy its expression into a new View.

## Edit and delete Views

The Views page lists every View with its title and filter. Each row has a menu to:

- **Edit** — load the View back into the form to change its title, icon, or filter
