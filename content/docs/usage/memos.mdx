...
| --- | --- |
| `property.has_link` | Contains one or more Markdown links |
| `property.has_code` | Contains code blocks or inline code |
| `property.has_task_list` | Contains at least one task list item |
| `property.has_incomplete_tasks` | Contains unchecked `- [ ]` task items |
