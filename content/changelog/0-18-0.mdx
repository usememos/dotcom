...
- PostgreSQL: **PostgreSQL** is supported, learn more in [Database Driver](https://www.usememos.com/docs/install/database#using-postgresql);
- Webhook: **Webhook** introduced, learn more in [Webhook](https://www.usememos.com/docs/advanced-settings/webhook).
