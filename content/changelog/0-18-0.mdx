...
- PostgreSQL: **PostgreSQL** is supported, learn more in [Database Driver](/docs/configuration/database);
- Webhook: **Webhook** introduced, learn more in [Webhook](/docs/integrations/webhooks).
