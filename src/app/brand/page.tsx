  ...
  return (
    <>
      <div className="w-full max-w-3xl flex flex-col justify-center items-center sm:px-16">
        ...
        <div className="mt-12 w-full grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-12">
        ...
        <div className="mt-6 sm:mt-12 w-full border p-4 flex justify-center items-center">
          <img src="/full-logo-landscape.png" alt="" />
        </div>
      </div>
    </>
  );
