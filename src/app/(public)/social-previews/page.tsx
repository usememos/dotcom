...
import { sortChangelogPages } from "@/features/editorial/lib/changelog";
import {
  getBlogIndexSocialPreview,
  getBlogSocialPreview,
  getChangelogIndexSocialPreview,
  getChangelogSocialPreview,
} from "@/features/editorial/lib/social-preview";
import { Footer } from "@/features/marketing/components/footer";
import { baseOptions } from "@/shared/config/layout";
import type { ContentSocialPreview, SocialPreviewImageKind } from "@/shared/content/social-preview";
...
function getAllContentSocialPreviews(): ContentSocialPreview[] {
  return [
    ...source
      .getPages()
