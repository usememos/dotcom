  ...
  return (
    <header className="mb-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        {isLatest && (
          <span className="px-3 py-1.5 bg-teal-600 text-white text-xs font-semibold rounded-full">Latest Release</span>
        )}
      </div>

      <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-100 sm:text-5xl mb-4 leading-tight">
        {version}
      </h1>
