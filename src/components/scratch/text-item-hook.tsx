...
export function TextItemHook({ item, onUpdate, onDelete, isSelected, onSelect, onDragComplete }: TextItemProps) {
  ...
  // Use custom drag hook - clean and declarative!
  const { isDragging } = useDraggable(containerRef, {
    ...
    enabled: !isResizing, // Disable drag while resizing
  });
