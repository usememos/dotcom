...
const Banner = ({ text, url }: { text: string; url: string }) => {
  return (
    <div className="relative w-full bg-blue-600 text-white hover:opacity-80">
      <Link className="mx-auto flex w-full items-center justify-center px-4 py-2" href={url}>
