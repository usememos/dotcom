    ...
    <div className="h-full flex flex-col justify-start items-start">
      <Head>
        ...
        <meta
          name="og:title"
          property="og:title"
          content="memos - A privacy-first, lightweight note-taking service. Easily capture and share your great thoughts."
        />
        <meta
          name="og:description"
          content="A privacy-first, lightweight note-taking service. Easily capture and share your great thoughts."
      ...
      <main className="w-full max-w-6xl h-auto grow mx-auto flex flex-col justify-start items-start px-4 sm:px-24 pt-4 pb-24">
        <div className="pt-12 w-full mx-auto prose prose-lg max-w-none hover:prose-a:text-blue-500">
